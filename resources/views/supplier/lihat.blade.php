        ...
        <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
            <div class="mdl-card mdl-shadow--2dp">
                <div class="mdl-card__title">
                    <h1 class="mdl-card__title-text">Supplier</h1>
                </div>
                <div class="mdl-card__supporting-text no-padding">
                    ...
                    <div class="mdl-card__actions">
                        <form method="GET" action="{{ URL('supplier/cari') }}">
                            @csrf
                    ...
                    <div class="mdl-card__actions">
                        {{ $suppliers->appends(Request::except('page'))->links('vendor.pagination.custom') }}
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="mdl-card mdl-shadow--2dp">
                @if (Request::segment(2) != 'edit')
                    ...
                    <div class="mdl-card__supporting-text">
                        <form action="{{ URL('supplier/prosestambah') }}" class="form" method="POST">
                            {{ csrf_field() }}
                            <div class="mdl-grid">
                            ...
                            <div class="mdl-grid">
                                <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input class="mdl-textfield__input" type="text" id="telepon" name="telepon" value="{{ Request::old('telepon') }}" />
                                    <label class="mdl-textfield__label" for="telepon">Telepon</label>
                                </div>
                                {{\App\Helpers\General::pesanErrorForm($errors->first('nama'))}}
                            </div>
                            <div class="mdl-grid">
                ...
                @else
                    ...
                    <div class="mdl-card__supporting-text">
                        <form action="{{ URL('supplier/prosesedit/'.$edit_suppliers->id) }}" class="form" method="POST">
                            {{ csrf_field() }}
                            @method('PATCH')
                            <div class="mdl-grid">
                                <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input class="mdl-textfield__input" type="text" id="nama" name="nama" value="{{ Request::old('nama') == '' ? $edit_suppliers->nama : Request::old('nama') }}" autofocus />
                                    <label class="mdl-textfield__label" for="nama">Nama</label>
                                </div>
                                {{\App\Helpers\General::pesanErrorForm($errors->first('nama'))}}
                            </div>
                            <div class="mdl-grid">
                                <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input class="mdl-textfield__input" type="text" id="telepon" name="telepon" value="{{ Request::old('telepon') == '' ? $edit_suppliers->telepon : Request::old('telepon') }}" />
                                    <label class="mdl-textfield__label" for="telepon">Telepon</label>
                                </div>
                                {{\App\Helpers\General::pesanErrorForm($errors->first('telepon'))}}
                            </div>
                            <div class="mdl-grid">
                                <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input class="mdl-textfield__input" type="text" id="alamat" name="alamat" value="{{ Request::old('alamat') == '' ? $edit_suppliers->alamat : Request::old('alamat') }}" />
                                    <label class="mdl-textfield__label" for="alamat">Alamat</label>
                                </div>
                                {{\App\Helpers\General::pesanErrorForm($errors->first('alamat'))}}
                            </div>
